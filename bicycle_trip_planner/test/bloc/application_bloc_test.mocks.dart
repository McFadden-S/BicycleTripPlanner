...
import 'package:bicycle_trip_planner/models/place_search.dart' as _i9;
import 'package:bicycle_trip_planner/services/places_service.dart' as _i8;
...
class MockPlacesService extends _i1.Mock implements _i8.PlacesService {
  ...
  String get prefixUrl =>
      (super.noSuchMethod(Invocation.getter(#prefixUrl), returnValue: '')
          as String);
  @override
  _i5.Future<List<_i9.PlaceSearch>> getAutocomplete(String? search) =>
      (super.noSuchMethod(Invocation.method(#getAutocomplete, [search]),
              returnValue:
                  Future<List<_i9.PlaceSearch>>.value(<_i9.PlaceSearch>[]))
          as _i5.Future<List<_i9.PlaceSearch>>);
  @override
